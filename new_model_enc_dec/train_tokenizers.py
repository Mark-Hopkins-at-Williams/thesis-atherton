...
def train_tokenizer(filename, params):
    ...
    #tokenizer.save_model(save_location, "model")
    new_tokenizer = BertTokenizerFast(tokenizer_object=tokenizer._tokenizer)
    new_tokenizer.save_pretrained(save_location)
